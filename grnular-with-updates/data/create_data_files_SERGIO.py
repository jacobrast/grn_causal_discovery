...
parser.add_argument('--K_valid', type=int, default=3, #5, #2, #1000,
                    help='Number of valid examples for a fixed D ')
parser.add_argument('--K_test', type=int, default=1, #100, #10,
...
parser.add_argument('--gen_DS', type=str,  default='DS1',#'no',
...
def get_filepath(args):
    ...
    SAVEPATH = file_prefix + '/data/saved_data/'
