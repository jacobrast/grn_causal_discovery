...
def helper_DS_data(args, k, DATA_NAME, u=1):
    ...
    if DATA_NAME == 'DS1':
        filepath = file_prefix + 'De-noised_100G_9T_300cPerT_4_DS1/'
        dim = 100
    elif DATA_NAME == 'DS2':
        filepath = file_prefix + 'De-noised_400G_9T_300cPerT_5_DS2/'
        dim = 400
    elif DATA_NAME == 'DS3':
        filepath = file_prefix + 'De-noised_1200G_9T_300cPerT_6_DS3/'
        dim = 1200
    else:
...
def get_DS_graph_MR(args): # 3 NOTE: please change the paths accordingly
    ...
    if DATA_NAME == 'DS1':
        ...
        filepath = 'De-noised_1200G_9T_300cPerT_6_DS3/'
        dim = 1200
    else:
        print('CHECK DATA NAME')
    given_edges = pd.read_csv(filepath+'gt_GRN.csv', header=None)
...
def create_interaction_regs_files(G1, args, RANDOM_NUM=''):# 6 : NOTE: change the folder paths 
    ...
    df_edge.to_csv(file_prefix + 'custom/gt_GRN'+RANDOM_NUM+'.csv', header=None, index=None)
    ...
    df_MR.to_csv(file_prefix + 'custom/Regs_cID'+RANDOM_NUM+'.txt', header=None, index=None)

    # 3. interaction file
    interaction_filename = file_prefix + 'custom/Interaction_cID'+RANDOM_NUM+'.txt'
